...
_pure_set_default pure_shorten_prompt_current_directory_length 100
...
_pure_set_default pure_color_username_normal pure_color_light
_pure_set_default pure_color_username_root pure_color_dark
_pure_set_default pure_show_username true
...
_pure_set_default pure_symbol_aws_profile_prefix "on " # ☁️
_pure_set_default pure_color_aws_profile pure_color_primary
...
_pure_set_default pure_symbol_container_prefix "via 🐋 " # suggestion: '🐋' or '📦'
